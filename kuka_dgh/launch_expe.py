...
prefix = "/home/skleff/Desktop/delta_f_real_exp/3d/integral/energy_dtau_final/"
suffix = "_FI"
...
if SIM:
    ...
    thread_head.start()
    thread_head.start_logging(32, prefix+CONFIG_NAME+"_REAL_"+str(datetime.now().isoformat())+suffix+".mds")
