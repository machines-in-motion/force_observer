...
plt.plot(time_lin, target_force_3d[N_START:N, 2], color='k', linewidth=4, linestyle='--', label='Reference', alpha=0.5) 
plt.plot(time_lin, force_3d_1[:,2], color='b', linewidth=4, label=label1, alpha=0.8)
plt.plot(time_lin, force_3d_2[:,2], color='g', linewidth=4, label=label2, alpha=0.8)
plt.plot(time_lin, force_3d_3[:,2], color='r', linewidth=4, label=label3, alpha=0.8)
